        ...
        <div className="relative z-10 text-center space-y-4">
          ...
          <div className="flex items-center justify-center gap-4">
            ...
            <div className="text-left">
              ...
              <p className="text-grass-soft text-xl">Habilidad: {Math.round(champion.skill)}</p>
            </div>
          </div>
          <p className="text-2xl text-white font-semibold mt-4">
            ¡Felicitaciones por ganar el Mundial!
          </p>
        </div>
      </div>
          ...
          <Card className="border-grass-soft">
            <div className="p-6 text-center space-y-3">
              <div className="flex justify-center items-center gap-2">
                ...
                <span className="font-arcade text-xl text-grass-soft">2°</span>
              </div>
              ...
              <p className="text-sm text-grass-soft">Subcampeón</p>
              <p className="text-sm text-grass-soft">Habilidad: {Math.round(runnerUp.skill)}</p>
            </div>
          </Card>
        </div>
          ...
          <Card className="border-gold transform md:scale-110 md:translate-y-[-1rem]">
            <div className="p-6 text-center space-y-3">
              <div className="flex justify-center items-center gap-2">
                ...
                <span className="font-arcade text-2xl text-gold">1°</span>
              </div>
              ...
              <p className="text-sm text-gold font-semibold">Campeón</p>
              <p className="text-sm text-gold">Habilidad: {Math.round(champion.skill)}</p>
            </div>
          </Card>
        </div>
            ...
            <Card className="border-led">
              <div className="p-6 text-center space-y-3">
                <div className="flex justify-center items-center gap-2">
                  ...
                  <span className="font-arcade text-xl text-led">3°</span>
                </div>
                ...
                <p className="text-sm text-led">Tercer Puesto</p>
                <p className="text-sm text-grass-soft">Habilidad: {Math.round(thirdPlace.skill)}</p>
              </div>
            </Card>
          </div>
        ) : (
        ...
        <div className="max-w-md mx-auto">
          <Card className="border-2">
            <div className="p-4 text-center space-y-2">
              <div className="flex justify-center items-center gap-2">
                <span className="font-arcade text-sm text-grass-soft">4to Puesto</span>
              </div>
              <div className="flex items-center justify-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-grass-soft">Habilidad: {Math.round(fourthPlace.skill)}</p>
                </div>
              </div>
            </div>
          </Card>
      ...
      <Card className="max-w-3xl mx-auto bg-grass/30">
        <div className="p-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
            <div>
              <div className="font-terminal text-3xl text-gold tabular-nums">1°</div>
            ...
            <div>
              <div className="font-terminal text-3xl text-grass-soft tabular-nums">2°</div>
              <div className="flex items-center justify-center gap-2 text-sm text-grass-soft">
            ...
            {thirdPlace && (
              <div>
                <div className="font-terminal text-3xl text-led tabular-nums">3°</div>
                <div className="flex items-center justify-center gap-2 text-sm text-grass-soft">
            ...
            {fourthPlace && (
              <div>
                <div className="font-terminal text-3xl text-grass-soft tabular-nums">4°</div>
                <div className="flex items-center justify-center gap-2 text-sm text-grass-soft">
